...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-12 22:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9ba0a475-ced6-4eb8-aa7d-fa4099e196e0.git
$ cd 9ba0a475-ced6-4eb8-aa7d-fa4099e196e0
```
